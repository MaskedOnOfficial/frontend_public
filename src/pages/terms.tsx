        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.05 }} className="glass-panel rounded-2xl p-6">
          ...
          <Section title="4. Account Registration and Security">
            ...
            <ul className="list-disc pl-5 space-y-1.5">
              ...
              <li>Notify us immediately at <a href="mailto:wemaskon@gmail.com" className="text-primary hover:underline">wemaskon@gmail.com</a> if you suspect any unauthorised access to or use of your Account.</li>
            </ul>
          ...
          <Section title="10. Payments and Transaction Processing">
            ...
            <p>10.5 <strong className="text-text">Payment Failures.</strong> If a payment fails or is declined, your Ticket booking shall not be confirmed. maskedOn is not liable for payment failures caused by network issues, bank declines, or Razorpay downtime. In the event of a double charge or erroneous deduction, please contact us at <a href="mailto:wemaskon@gmail.com" className="text-primary hover:underline">wemaskon@gmail.com</a> within seven (7) days of the transaction date.</p>
            <p>10.6 <strong className="text-text">Taxes.</strong> You are responsible for all applicable taxes on your purchases. maskedOn will collect and remit Goods and Services Tax (GST) and any other taxes as required under Applicable Law. Tax invoices may be requested by writing to <a href="mailto:wemaskon@gmail.com" className="text-primary hover:underline">wemaskon@gmail.com</a>.</p>
          </Section>
          ...
          <Section title="12. Refund and Cancellation Policy">
            ...
            <p>12.6 <strong className="text-text">Refund Disputes.</strong> All refund-related disputes must be raised with us at <a href="mailto:wemaskon@gmail.com" className="text-primary hover:underline">wemaskon@gmail.com</a> within fourteen (14) days of the relevant Event date. maskedOn's determination on refund disputes shall be final and binding, subject to any statutory rights you may have under the Consumer Protection Act, 2019.</p>
          ...
          <Section title="20. Moderation, Reporting, and Grievance Redressal">
            <p>20.1 <strong className="text-text">Reporting Violations.</strong> If you encounter any content or conduct on the Platform that you believe violates these Terms, our community standards, or any Applicable Law, you may report it through the in-app reporting feature or by writing to us at <a href="mailto:wemaskon@gmail.com" className="text-primary hover:underline">wemaskon@gmail.com</a>.</p>
            <p>20.2 <strong className="text-text">Grievance Officer.</strong> In accordance with Rule 3(2) of the Intermediary Guidelines, 2021, maskedOn designates its Grievance Officer who can be reached at <a href="mailto:wemaskon@gmail.com" className="text-primary hover:underline">wemaskon@gmail.com</a>. The Grievance Officer will acknowledge receipt of a complaint within twenty-four (24) hours and endeavour to resolve it within fifteen (15) days of receipt, in accordance with the timelines prescribed by the Intermediary Guidelines.</p>
